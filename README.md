...
# Introduction
This microservices app is composed of Eureka, Zuul Api Gateway, Rest Api and a Proxy based on LoadBalancerClient.
You can perform CRUD through Zuul gateway the base addresses are:
localhost:8080/api/todos for the todo-service and<br>
localhost:8080/proxy/todos for the proxy-service<br>
both requests will go through Zuul gateway.
